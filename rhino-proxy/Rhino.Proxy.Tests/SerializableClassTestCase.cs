...
using Rhino.Proxy.Classes;
using Rhino.Proxy.Serialization;
using Rhino.Proxy.Test.ClassInterfaces;
using Rhino.Proxy.Test.Mixins;
...
namespace Rhino.Proxy.Tests
{
	...
	public class SerializableClassTestCase
	{
		...
		public void CreateSerializable()
		{
			...
			MySerializableClass proxy =
				(MySerializableClass) generator.CreateClassProxy(typeof (MySerializableClass), 
		...
		public void SimpleProxySerialization()
		{
			...
			MySerializableClass proxy =
				(MySerializableClass) generator.CreateClassProxy(typeof (MySerializableClass), new StandardInterceptor());
		...
		public void SerializationDelegate()
		{
			...
			MySerializableClass2 proxy =
				(MySerializableClass2) generator.CreateClassProxy(typeof (MySerializableClass2), new StandardInterceptor());
		...
		public void SimpleInterfaceProxy()
		{
			...
			object proxy = generator.CreateProxy(typeof (IMyInterface), new StandardInterceptor(), new MyInterfaceImpl());
		...
		public void CustomMarkerInterface()
		{
			...
			object proxy =
				new ProxyGenerator().CreateClassProxy(typeof (ClassWithMarkerInterface),
		...
		public void MixinSerialization()
		{
			...
			object proxy = generator.CreateCustomClassProxy(typeof (SimpleClass), new StandardInterceptor(), context);
