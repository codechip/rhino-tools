namespace Rhino.Etl.Core.Operations
{
    ...
    public abstract class SqlBulkInsertOperation : AbstractDatabaseOperation
    {
        ...
        protected SqlBulkInsertOperation(string connectionStringName, string targetTable) : this(connectionStringName, targetTable, 600)
        {
        ...
        protected SqlBulkInsertOperation(string connectionStringName, string targetTable, int timeout) : base(connectionStringName)
        {
