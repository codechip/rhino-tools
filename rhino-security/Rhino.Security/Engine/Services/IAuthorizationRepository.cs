...
namespace Rhino.Security.Engine.Services
{
  ...
  public interface IAuthorizationRepository
  {
    ...
    IUsersGroup[] GetAssociatedUsersGroupFor(IUser user);

    /// <summary>
    /// Gets the users group by its name
    /// </summary>
    /// <param name="groupName">Name of the group.</param>
    IUsersGroup GetUsersGroupByName(string groupName);

    /// <summary>
    /// Gets the entities group by its name
    /// </summary>
    /// <param name="groupName">The name of the group.</param>
    IEntitiesGroup GetEntitiesGroupByName(string groupName);
    ...
    /// <returns></returns>
    IEntitiesGroup[] GetAssociatedEntitiesGroupsFor<TEntity>(TEntity entity) where TEntity : class;
    ...
    void AssociateEntityWith<TEntity>(TEntity entity, IEntitiesGroup group) where TEntity : class;
    ...
    /// <param name="user">The user.</param>
    /// <param name="group">The group.</param>
    void AssociateUserWith(IUser user, IUsersGroup group);
    ...
    /// <param name="usersGroupName">Name of the users group.</param>
    /// <returns></returns>
    IUsersGroup CreateChildUserGroupOf(string parentGroupName, string usersGroupName);
    ...
    /// <param name="usersGroupName">Name of the users group.</param>
    /// <returns></returns>
    IUsersGroup[] GetAncestryAssociation(IUser user, string usersGroupName);
